...
namespace Concurrent_forms
{
    public partial class Level2 : Form
    {
        ...
        public void pictureBox5_Click(object sender, EventArgs e)
        {
            try
            {
                if ((slot1.Image.Equals(pictureBox8.Image)) && (slot2.Image.Equals(pictureBox7.Image)) && (slot3.Image.Equals(pictureBox8.Image)))
                {
                    System.Media.SoundPlayer click = new System.Media.SoundPlayer();
        ...
        public void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            richTextBox1.Text = "       Filtry LC odnoszą się do obwodów składających się z kombinacji cewek (L) i kondensatorów (C) do odcinania lub przepuszczania określonych pasm częstotliwości sygnału elektrycznego.\r\n       Kondensatory blokują prąd stały, ale łatwiej przepuszczają prąd przemienny przy wyższych częstotliwościach. I na odwrót, cewki przepuszczają prąd stały, ale trudniej przepuszczają prąd przemienny przy wyższych częstotliwościach.\r\n Innymi słowy, kondensatory i cewki są elementami biernymi o zupełnie przeciwnych właściwościach. Łącząc te komponenty o przeciwnych właściwościach, można wyciąć szum i zidentyfikować określone sygnały.";
        }
